class Delivery < ActiveRecord::Base
  ...
  named_scope :delivered_this_week, :conditions => {:state => "delivered", :delivered_at => "between #{Time.zone.now.at_beginning_of_week.to_s(:db)} and #{Time.zone.now.at_end_of_week.to_s(:db)}"}
